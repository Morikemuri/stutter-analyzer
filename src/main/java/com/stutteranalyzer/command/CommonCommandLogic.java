...
public class CommonCommandLogic {
    ...
    public static int showHelp(CommandSourceStack src) {
        ...
        src.sendSuccess(() -> CommandFeedback.info("  /sa show <time>         - Show recent events (5m/10m/30m/1h)"), false);
        src.sendSuccess(() -> CommandFeedback.info("Other:"), false);
        src.sendSuccess(() -> CommandFeedback.info("  /sa optimize suggest    - Scan and suggest optimization mods (async)"), false);
