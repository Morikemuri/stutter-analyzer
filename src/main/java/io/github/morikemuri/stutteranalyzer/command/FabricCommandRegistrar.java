        ...
        dispatcher.register(Commands.literal(root)
            ...
            .then(Commands.literal("alerts")
                ...
                .then(Commands.literal("minor")
                    .executes(c -> safe(c.getSource(), () -> CommonCommandLogic.alertsSetMode(c.getSource(), io.github.morikemuri.stutteranalyzer.core.AlertMode.MINOR))))
                .then(Commands.literal("medium")
                    .executes(c -> safe(c.getSource(), () -> CommonCommandLogic.alertsSetMode(c.getSource(), io.github.morikemuri.stutteranalyzer.core.AlertMode.MEDIUM))))
                .then(Commands.literal("severe")
                    .executes(c -> safe(c.getSource(), () -> CommonCommandLogic.alertsSetMode(c.getSource(), io.github.morikemuri.stutteranalyzer.core.AlertMode.SEVERE))))
                .then(Commands.literal("extreme")
                    .executes(c -> safe(c.getSource(), () -> CommonCommandLogic.alertsSetMode(c.getSource(), io.github.morikemuri.stutteranalyzer.core.AlertMode.EXTREME))))
                .then(Commands.literal("off")
                    .executes(c -> safe(c.getSource(), () -> CommonCommandLogic.alertsSetMode(c.getSource(), io.github.morikemuri.stutteranalyzer.core.AlertMode.OFF))))
