...
import io.github.morikemuri.stutteranalyzer.platform.SAFabricPlatform;
...
public class CommonCommandLogic {
    ...
    public static int showVersion(CommandSourceStack src) {
        ...
        src.sendSuccess(() -> CommandFeedback.row(net.minecraft.network.chat.Component.translatable("stutteranalyzer.row.minecraft"), net.minecraft.network.chat.Component.literal(io.github.morikemuri.stutteranalyzer.platform.PlatformInfo.minecraftVersion())), false);
        ...
        io.github.morikemuri.stutteranalyzer.update.UpdateCheckResult updateResult = io.github.morikemuri.stutteranalyzer.update.UpdateChecker.getCached();
        ...
        if (!updatesEnabled) {
            ...
            io.github.morikemuri.stutteranalyzer.update.UpdateChecker.performCheckAsync();
    ...
    public static int f3Status(CommandSourceStack src) {
        ...
        boolean enabled = io.github.morikemuri.stutteranalyzer.client.DebugHudStatusProvider.isF3Enabled();
        src.sendSuccess(() -> CommandFeedback.row(
    ...
    public static int f3On(CommandSourceStack src) {
        ...
        io.github.morikemuri.stutteranalyzer.client.DebugHudStatusProvider.setF3Enabled(true);
    ...
    public static int f3Off(CommandSourceStack src) {
        ...
        io.github.morikemuri.stutteranalyzer.client.DebugHudStatusProvider.setF3Enabled(false);
    ...
    public static int f3Toggle(CommandSourceStack src) {
        ...
        boolean current = io.github.morikemuri.stutteranalyzer.client.DebugHudStatusProvider.isF3Enabled();
