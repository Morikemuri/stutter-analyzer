...
public class CommonCommandLogic {
    ...
    public static int showVersion(CommandSourceStack src) {
        ...
        src.sendSuccess(() -> CommandFeedback.row(net.minecraft.network.chat.Component.translatable("stutteranalyzer.row.minecraft"), net.minecraft.network.chat.Component.literal("1.21.1")), false);
    ...
    public static int f3Status(CommandSourceStack src) {
        ...
        if (enabled) {
            String current = io.github.morikemuri.stutteranalyzer.client.F3StatusFormatter.format().replaceAll("§.", "");
